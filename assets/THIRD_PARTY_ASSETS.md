...
- Status: downloaded 2026-08-09 from the official DCSS repository mirror; the original archive and unused pack files are archived under `_unused/vendor/unused-dcss-crawl/`.
...
- License: Creative Commons Zero (CC0 1.0)
- Used files: 80 OGG sound effects under `_unused/assets/audio/vendor/80-cc0-rpg-sfx/` (blade, book, chain, creature, item, lock, metal, spell, stone, wood).
- Status: downloaded and verified; not yet wired into `js/audio.js`; archived under `_unused/` on 2026-08-09.
...
- `_unused/sources/v19-key-art-concepts.png`: original v0.19 Tesla coil, incendiary flask, zombie and merchant design reference sheet.
- `_unused/sources/v19-zombie-walk-source.png`: original four-frame zombie walk source derived from that reference.
...
- The remaining older image-generation source sheets are archived under `_unused/sources/` for provenance.
...
- Status: actively referenced by the atlas manifests as of 2026-08-09; only the 21 exact atlas sources and `LICENSE.txt` remain under `assets/sprites/vendor/ninja-adventure/`, with the rest archived under `_unused/vendor/unused-ninja-adventure/`.
