...
window.CFG = {
  ...
  BASE_STATS: {
    ...
    lifesteal: 0, shieldMax: 0, shieldCd: 8
  },
  ...
  WEAPONS: {
    ...
    arcanebolt: { name: '奥术飞弹', icon: 'w_arcanebolt', evo: 'arcanestorm', evoNeed: 'ps_core',
      ...
      lv: [ { count: 1 }, { dmg: 8 }, { count: 1 }, { cdM: 0.85 }, { dmg: 12 }, { count: 1 }, { dmg: 16, cdM: 0.85 } ] },
    windbow: { name: '猎风弩', icon: 'w_windbow', evo: 'featherstorm', evoNeed: 'ps_eagle',
      ...
      lv: [ { count: 1 }, { dmg: 8 }, { pierce: 1 }, { count: 1 }, { dmg: 10, cdM: 0.88 }, { count: 1 }, { dmg: 14, pierce: 2 } ] },
    ...
    whirlaxe: { name: '回旋斧', icon: 'w_whirlaxe', evo: 'worldender', evoNeed: 'ps_belt',
      ...
      base: { dmg: 20, cd: 1.5, count: 1, speed: 300, pierce: 6, size: 16, knock: 110 },
      lv: [ { count: 1 }, { dmg: 14 }, { count: 1 }, { cdM: 0.85 }, { dmg: 20 }, { count: 1 }, { dmg: 26, areaM: 1.3 } ] },
    chainlight: { name: '闪电链', icon: 'w_chainlight', evo: 'thorwrath', evoNeed: 'ps_boots',
      desc: '雷击随机敌人并在敌群间跳跃',
      base: { dmg: 22, cd: 1.9, count: 1, speed: 0, pierce: 0, size: 8, chains: 3, range: 250, stun: 0.15, knock: 0 },
      lv: [ { chains: 1 }, { stun: 0.1 }, { count: 1 }, { chains: 2, stun: 0.1 }, { cdM: 0.82 }, { dmg: 14, stun: 0.15 }, { chains: 2, dmg: 16, stun: 0.2 } ] },
    frostnova: { name: '寒冰新星', icon: 'w_frostnova', evo: 'absolutezero', evoNeed: 'ps_clover',
      desc: '周期性冻结冲击波,减速敌人',
      base: { dmg: 14, cd: 3.2, count: 1, speed: 260, pierce: -1, size: 135, slow: 0.35, slowDur: 1.5, knock: 30 },
      lv: [ { dmg: 6 }, { slowDur: 0.3 }, { cdM: 0.85 }, { slow: 0.05, slowDur: 0.3 }, { areaM: 1.2 }, { slowDur: 0.4 }, { dmg: 12, slow: 0.05, slowDur: 0.4 } ] },
    fireflask: { name: '烈焰瓶', icon: 'w_fireflask', evo: 'infernosea', evoNeed: 'ps_belt',
      ...
      lv: [ { count: 1 }, { poolDmg: 5, poolDur: 0.5 }, { areaM: 1.2 }, { count: 1, poolDur: 0.5 }, { poolDmg: 7, durM: 1.3 }, { cdM: 0.85 }, { count: 1, poolDmg: 9, poolDur: 0.8 } ] },
    shadowdagger: { name: '暗影匕首', icon: 'w_shadowdagger', evo: 'thousandcuts', evoNeed: 'ps_eagle',
      ...
      lv: [ { dmg: 5 }, { count: 1 }, { dmg: 6 }, { cdM: 0.85 }, { count: 1 }, { dmg: 8 }, { count: 1, dmg: 9 } ] },
    ...
    holytome: { name: '圣典', icon: 'w_holytome', evo: 'forbidden', evoNeed: 'ps_power',
      desc: '掷出回旋圣书,去而复返',
      base: { dmg: 16, cd: 2.7, count: 1, speed: 340, pierce: 8, size: 16, knock: 60 },
  ...
  PASSIVES: {
    ...
    ps_vampire:     { name: '吸血鬼之牙', icon: 'ps_power', maxLv: 3, desc: '击杀回复生命 1%/级',
      apply: function (s, lv) { s.lifesteal = (s.lifesteal || 0) + 0.01 * lv; } },
    ps_barrier:     { name: '护盾符文', icon: 'ps_core', maxLv: 3, desc: '每 8 秒恢复护盾,每级+10',
      apply: function (s, lv) { s.shieldMax = (s.shieldMax || 0) + (10 + 10 * lv); s.shieldCd = 8; } }
  },
