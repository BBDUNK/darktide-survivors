...
window.CFG = {
  ...
  // ---------------- 角色 ----------------
  // 名字取职业英文谐音中文空耳;desc 一句人设 + 一句开局武器提示
  CHARS: [
    { id: 'knight', name: '骑士·奈特', sprite: 'char_knight', weapon: 'crossblade',
      desc: '全村最硬的盾,也是全村最后一个骑士。武器:十字剑气', bonusText: '护甲 +2,生命 +20',
      mods: { armor: 2, hp: 20 }, unlock: null },
    { id: 'mage', name: '法师·梅姬', sprite: 'char_mage', weapon: 'arcanebolt',
      desc: '被学院赶出去的天才,毕业证忘带了。武器:奥术飞弹', bonusText: '冷却 -12%',
      mods: { cd: -0.12 }, unlock: null },
    { id: 'ranger', name: '游侠·兰杰', sprite: 'char_ranger', weapon: 'windbow',
      desc: '风之森的独行猎手,箭比话多。武器:猎风弩', bonusText: '移速 +12%,暴击率 +5%',
      mods: { speedPct: 0.12, crit: 0.05 }, unlock: { achv: 'a_kill_1000' } },
    { id: 'cleric', name: '神官·可莉', sprite: 'char_cleric', weapon: 'holyaura',
      desc: '守望黎明的末代祭司,光就是她最大的脾气。武器:圣光环', bonusText: '生命回复 +0.6/秒,范围 +10%',
      mods: { regen: 0.6, areaPct: 0.10 }, unlock: { achv: 'a_survive_15' } },
    { id: 'berserker', name: '狂战士·伯泽', sprite: 'char_berserker', weapon: 'whirlaxe',
      desc: '北地蛮王,生气的时候连自己都打。武器:回旋斧', bonusText: '伤害 +25%,生命 -20',
      mods: { mightPct: 0.25, hp: -20 }, unlock: { achv: 'a_kill_5000' } },
    { id: 'chrono', name: '时行者·克罗', sprite: 'char_chrono', weapon: 'teslacoil',
      desc: '来自终局之后的旅人,总说"我早知道了"。武器:磁暴线圈', bonusText: '幸运 +20%,冷却 -8%',
