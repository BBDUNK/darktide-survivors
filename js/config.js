...
window.CFG = {
  ...
  BOSSES: {
    ...
    boss_bonelord:  { name: '骸骨领主', hp: 70000, dmg: 26, spd: 50, r: 48, xp: 120,
      music: 'boss_bone', shotCol: '#e8e0c8',
      desc: '第 10 分钟:环形骨矢弹幕,连续蓄力冲撞' },
    boss_abysseye:  { name: '深渊之眼', hp: 140000, dmg: 30, spd: 42, r: 52, xp: 220,
      music: 'boss_abyss', shotCol: '#c46bff',
      desc: '第 15 分钟:螺旋弹幕,瞬移到背后并召唤怨灵' },
    boss_darklord:  { name: '暗潮魔王', hp: 300000, dmg: 36, spd: 55, r: 56, xp: 500,
